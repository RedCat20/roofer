...
const FullTriangle: FC<Props> = ({figureASide,figureBSide,figureCSide, startCoords,cellSize,gridHeight,calcTrianglePointsCallback}) => {
    ...
    let calcCoords = () => {
        if ((figureASide > figureBSide + figureCSide) || (figureBSide > figureASide + figureCSide) || (figureCSide > figureASide + figureBSide)) {
            return;
        }
        ...
        let R1=side2, R2=side1, R3=baseLength;
